              ...
              <div className="flex flex-col md:flex-row justify-between">
                ...
                <div>
                  <Link href="https://i1.wp.com/eforms.com/images/2017/07/Consent-Form-Template.png?fit=1600%2C2070&ssl=1">
                    <button class="mt-3 md:mt-0 bg-help px-4 md:px-5 py-3 text-md shadow-sm font-medium text-white rounded-lg hover:bg-help-dark"> <DownloadIcon className="h-6 w-6 inline-block"/> Download</button>
                  </Link>
                </div>
              </div>
