        ...
        <div className="bg-white py-16 px-4 overflow-hidden sm:px-6 lg:px-8 lg:py-24">
          <div className="relative max-w-xl mx-auto">
            ...
            <div className="text-center">
              <h2 className="text-3xl font-extrabold tracking-tight text-gray-900 sm:text-4xl">Sign In</h2>
            </div>
            <div className="sm:col-span-2 mt-3">{refer ? <Alert type='warning' message="Please login to continue.." icon="warning" /> : ""}</div>
            <div className="mt-6">
              <form action="#" method="POST" className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-1">
                    <input type="text" name="email" id="email" autoComplete="email" required onChange={(e) => setEmail(e.target.value)} className="py-3 px-4 block w-full shadow-sm focus:ring-help focus:border-help border-gray-300 rounded-md" />
                  </div>
                </div>
                ...
                <div className="sm:col-span-2">
                  ...
                  <div className="mt-1">
                    <input id="password" name="password" type="password" required onChange={(e) => setPassword(e.target.value)} className="py-3 px-4 block w-full shadow-sm focus:ring-help focus:border-help border-gray-300 rounded-md" />
                  </div>
                </div>
                <div className="sm:col-span-2">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <input id="remember_me" name="remember_me" type="checkbox" className="h-4 w-4 text-indigo-600 focus:ring-help border-gray-300 rounded" />
                    ...
                    <div className="text-sm">
                      <Link href="/forgot-password">
                        <a className="font-medium text-help hover:text-help-dark">Forgot your password?</a>
                      </Link>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 sm:col-span-2">
                  ...
                  <div className="sm:col-span-2">
                    <Link href="/register">
                      <button
                        type="submit"
                        className="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-help border-help hover:bg-help hover:text-help-lighter focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-help">
                        Create Account
                      </button>
                    </Link>
                  </div>
